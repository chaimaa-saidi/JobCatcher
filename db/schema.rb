...
ActiveRecord::Schema.define(version: 2021_12_28_233848) do
  ...
  create_table "recruteurs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["email"], name: "index_recruteurs_on_email", unique: true
    t.index ["reset_password_token"], name: "index_recruteurs_on_reset_password_token", unique: true
  end
